...
var status2;
    ...
    function getIncident(logs){
        
        const incidLogIndex = logs.findIndex(log => log.type === 1)
        const incidLogDur = logs.duration
            
        let message;
        console.log(incidLogDur)
        if(incidLogIndex === -1){
            message = "Sem incidentes"
       
        }else if (incidLogIndex === 1 ) {       
            
            message = `${moment
                .unix(logs[incidLogIndex].datetime)
                .format("YYYY-MM-DD, h:mm:ss")} (${secondsToHms(logs[incidLogIndex].duration)})`
        ...
        <div className="monitor">
            ...
            <div className="stats-container">
                ...
                <div className="status-numbers">
                    ...
                    <div className="number">
                        <div className="number-card latest-incident">
                            <label>Latest incident</label>
                            <div className="value">{getIncident(logs)}</div>
                        </div>
                    </div>
                    <div className="number">
                    ...
                    {/* <div className="number">
                        <div className="number-card incident">
